...
public class MouseLook : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 look_Angles;
    ...
    void lookAround()
    {
        ...
        look_Angles.x = Mathf.Clamp(look_Angles.x, default_Look_Limits.x, default_Look_Limits.y); // not alow to go beyond the limits
